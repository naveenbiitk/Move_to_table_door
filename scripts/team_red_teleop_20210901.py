...
def simple_func(robot,controller_state):
	simple_robot = controller_state['left_button_pressed']
	#lift_height_m = 0.6
	if simple_robot and robot.is_calibrated():
		...
		#wrist_yaw_rotate_rad = deg_to_rad(25.0)  # 60.0 #10.0 #5.0
 		#wrist_yaw_accel = 15.0  # 25.0 #30.0 #15.0 #8.0 #15.0
    		...
    		#wrist_yaw_slew_down = 0.15
    		#wrist_yaw_slew_up = .02
		#robot.end_of_arm.move_to('wrist_yaw', wrist_yaw_rotate_rad)
# ######################### MAIN ########################################
    ...
    try:
        ...
        while True:
            ...
            if not robot.is_calibrated():
                ...
                simple_func(robot, controller_state)
